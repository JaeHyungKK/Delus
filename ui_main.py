...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QSize(1500, 1020))
        palette = QPalette()
...
"}")
        ...
        # 검색 엔진 윈도우 #
        self.SearchEngine_widget = SearchEngineWindow()
        self.SearchEngine_widget.setObjectName(u"SearchEngine_widget")
        ...
        self.label_6 = QLabel(self.SearchEngine_widget)
        ...
        self.label = QLabel(self.SearchEngine_widget)
        ...
        self.label_7 = QLabel(self.SearchEngine_widget)
...
"")
        ...
        # 최초 시작 페이지에 검색 엔진 위젯을 추가
        self.stackedWidget.addWidget(self.SearchEngine_widget)
